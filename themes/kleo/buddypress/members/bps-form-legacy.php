...
else
{
    ...
    ?>
    <div class="item-list-tabs bps_header" style="float: left; width: 100%;">
        <ul>
...
?>
<div id='<?=$form_id?>' class='bps-form bps-form-legacy clear clearfix'>
    <?php echo do_shortcode(' [gmw form="1"]'); ?>
</div>
<?php //echo do_shortcode(' [gmw map="1"]'); ?>

<?php
// echo "<form action='$F->action' method='$F->method'  class='bps-form bps-form-legacy clear clearfix'>\n";
